---
title: "Challenge-2"
author: "Yang Juan Hun, A0255392Y"
date: "`r Sys.Date()`"
output:
...
**Solution:** Comma-Separated Values -- Can easily be opened and edited in any spreadsheet software.
...
playlist.dat <- read_csv("playlist_data.csv")  
...
```
<br>
```{r, out.height= "250px",out.width= "500px",echo=TRUE,eval=TRUE,fig.cap="Insert caption here"}
knitr::include_graphics("read_csv_help.jpg")
```
<br>

**Question 1.6:** What does the `skip` argument in the read_csv() function do?

**Solution:** *Skips the specified number of lines of the file before reading data.*
<br>
<br>
...
ggplot(playlist.dat) +
  aes(x=Age,y=Rating) +
  geom_point(shape = 11)+
  labs(title = "Scatter Plot of DJ Age against DJ Rating", caption = "There is likely a weak positive correlation between age and rating.")
